    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap justify-between">
            <div class="w-full md:w-1/4 mb-6 md:mb-0">
                <h3 class="text-xl font-semibold mb-4">Eduhigh</h3>
                <p class="text-gray-400">Sistem Bimbingan Skripsi Digital yang memudahkan proses penulisan dan
                    bimbingan skripsi.</p>
            </div>
            <div class="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <div class="w-full md:w-1/4 mb-6 md:mb-0">
                ...
                <ul class="space-y-2">
                    <li class="flex items-center">
                        ...
                        <a href="mailto:info@eduhigh.com" class="text-gray-400 hover:text-white">info@eduhigh.com</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 text-sm text-center text-gray-400">
            © {{ date('Y') }} Eduhigh. Hak Cipta Dilindungi.
        </div>
    </div>
</footer>
