<x-layout bodyClass="g-sidenav-show bg-gray-100" title="Review Seminar Hasil">
    <x-navbars.sidebar activePage="delegate-seminar-resultSeminar"></x-navbars.sidebar>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="text-white text-sm mb-0 opacity-8">
                                        Kelola pengajuan seminar resultSeminar mahasiswa bimbingan Anda
                                    </p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary assign-penguji"
                                                        ...
                                                        data-resultSeminar-id="{{ $resultSeminar->id }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            assignPengujiModal.addEventListener('show.bs.modal', async function(event) {
                ...
                const hasilId = button.getAttribute('data-resultSeminar-id');

                submitButton.disabled = true;
                pengujiSelect.disabled = true;

                assignPengujiForm.action = `/dashboard/resultSeminars/${hasilId}/assign-penguji`;

                try {
                    const response = await fetch(
                        `/dashboard/resultSeminars/${hasilId}/available-dosens`);
